import {
   FiActivity as TransactionsIcon, FiBarChart2 as DashboardIcon, FiBell as NotifyIcon,
   FiCheckCircle as ApprovalsIcon, FiDatabase as PlansIcon, FiLogOut as LogoutIcon,
