        ...
        <div className={`simple-chart py-4 md:px-6 md:bg-white md:border rounded-lg space-y-6 ${shadow && "md:shadow-lg"}`}>
            ...
            <div className="flex space-x-2 md:space-x-8 justify-center">
                {
                    dateFilterOptions.map(dateRange => {
                        const selected = endDate.label === dateRange
                        return (
                            <div
                                key={dateRange}
                                ...
                                onClick={() => setEndDate?.(getPastDate(dateRange))}
            ...
            <div ref={containerRef}>
                ...
                >
                    ...
                    {
                        //x-axis
                        //since the number of days is calculated by endDate prop any of the dataSet would suffice
